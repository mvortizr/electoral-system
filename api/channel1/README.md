...
docker build -t mvortizr/channel1_api:v1.37 .
#(docker tag my-image:latest your-docker-hub-username/repository-name:tag
#)

# correr
docker run -p 3000:3000 mvortizr/channel1_api:v1.15

#pull from dockerhub
docker pull docker.io/mvortizr/channel1_api:v1.37


# pushear a dockerhub
docker login
docker push mvortizr/channel1_api:v1.37
