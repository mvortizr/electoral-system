...
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.voting_system.com --tls --cafile "${PWD}/organizations/ordererOrganizations/voting_system.com/orderers/orderer.voting_system.com/msp/tlscacerts/tlsca.voting_system.com-cert.pem" -C election-ch1-roll -n ch1_cc --peerAddresses localhost:7051 --tlsRootCertFiles "${PWD}/organizations/peerOrganizations/org1.voting_system.com/peers/peer0.org1.voting_system.com/tls/ca.crt" -c '{"function":"InitLedger","Args":[]}'
